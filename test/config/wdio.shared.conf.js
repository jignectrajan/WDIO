...
export const config = {
    ...
    //
    // The specs are defined as an array of speåc files (optionally using wildcards
   ...
   */
     ...
     */
    //Uncomment when needed to pass environment & also uncomment file environment.conf.js
    ...
    afterTest: async function (step, scenario, { error, duration, passed }, context) {
        ...
        if (!passed) {
            ...
            let fileName = `TESTFAIL_${test.title.replace(/\s+/g, '')}${timeStamp}.png`
    ...
    /**
    * Gets executed when a refre    sh happens.
